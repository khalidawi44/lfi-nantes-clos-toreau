...
define('LFI_NCT_VERSION', '3.255.0');
...
require_once LFI_NCT_PATH . 'includes/event-kermesse-republicaine-20260714.php';
require_once LFI_NCT_PATH . 'includes/membres.php';
require_once LFI_NCT_PATH . 'includes/sms.php';
require_once LFI_NCT_PATH . 'includes/sms-blocklist.php';
...
require_once LFI_NCT_PATH . 'includes/app-ux.php';
require_once LFI_NCT_PATH . 'includes/assistant-nav.php';
...
require_once LFI_NCT_PATH . 'includes/content-store.php';
require_once LFI_NCT_PATH . 'includes/aide-juridictionnelle.php';
...
require_once LFI_NCT_PATH . 'includes/assistant-ia.php';
require_once LFI_NCT_PATH . 'includes/ai-claude.php';
require_once LFI_NCT_PATH . 'includes/carto.php';
require_once LFI_NCT_PATH . 'includes/carto-seed.php';
require_once LFI_NCT_PATH . 'includes/auto-deploy.php';
require_once LFI_NCT_PATH . 'includes/prefecture.php';
require_once LFI_NCT_PATH . 'includes/reussites.php';
require_once LFI_NCT_PATH . 'includes/victoires.php';
require_once LFI_NCT_PATH . 'includes/degats.php';
require_once LFI_NCT_PATH . 'includes/rats.php';
require_once LFI_NCT_PATH . 'includes/presse.php';
require_once LFI_NCT_PATH . 'includes/qr-enquete.php';
require_once LFI_NCT_PATH . 'includes/elue-argumentaire.php';
require_once LFI_NCT_PATH . 'includes/prestataires.php';
require_once LFI_NCT_PATH . 'includes/episodes.php';
require_once LFI_NCT_PATH . 'includes/dossier-wizard.php';
require_once LFI_NCT_PATH . 'includes/alertes.php';
require_once LFI_NCT_PATH . 'includes/modules.php';
require_once LFI_NCT_PATH . 'includes/guide.php';
require_once LFI_NCT_PATH . 'includes/groupes.php';
require_once LFI_NCT_PATH . 'includes/ga-tenancy.php';
require_once LFI_NCT_PATH . 'includes/ga-perso.php';
require_once LFI_NCT_PATH . 'includes/event-inscriptions.php';
require_once LFI_NCT_PATH . 'includes/volet-national.php';
require_once LFI_NCT_PATH . 'includes/sauvegarde.php';
require_once LFI_NCT_PATH . 'includes/onboarding.php';
require_once LFI_NCT_PATH . 'includes/partenaire.php';
require_once LFI_NCT_PATH . 'includes/demo-national.php';
require_once LFI_NCT_PATH . 'includes/avocat.php';
require_once LFI_NCT_PATH . 'includes/justice.php';
require_once LFI_NCT_PATH . 'includes/volet-ase.php';
require_once LFI_NCT_PATH . 'includes/volet-sante.php';
require_once LFI_NCT_PATH . 'includes/compta.php';
require_once LFI_NCT_PATH . 'includes/activite.php';
require_once LFI_NCT_PATH . 'includes/robot.php';
require_once LFI_NCT_PATH . 'includes/ingest.php';
require_once LFI_NCT_PATH . 'includes/inbox.php';
require_once LFI_NCT_PATH . 'includes/bailleurs.php';
require_once LFI_NCT_PATH . 'includes/journal.php';
require_once LFI_NCT_PATH . 'includes/strategie.php';
require_once LFI_NCT_PATH . 'includes/rgpd.php';
require_once LFI_NCT_PATH . 'includes/psy.php';
require_once LFI_NCT_PATH . 'includes/penal.php';
require_once LFI_NCT_PATH . 'includes/architecte.php';
require_once LFI_NCT_PATH . 'includes/prejudice.php';
require_once LFI_NCT_PATH . 'includes/jurisprudence.php';
require_once LFI_NCT_PATH . 'includes/mailcheck.php';
require_once LFI_NCT_PATH . 'includes/coordination.php';
require_once LFI_NCT_PATH . 'includes/mobilisation.php';
require_once LFI_NCT_PATH . 'includes/agenda-sync.php';
require_once LFI_NCT_PATH . 'includes/reponses.php';
require_once LFI_NCT_PATH . 'includes/signatures.php';
require_once LFI_NCT_PATH . 'includes/relogement.php';
require_once LFI_NCT_PATH . 'includes/frais.php';
require_once LFI_NCT_PATH . 'includes/accueil.php';
require_once LFI_NCT_PATH . 'includes/strategie-politique.php';
require_once LFI_NCT_PATH . 'includes/audit-nmh.php';
require_once LFI_NCT_PATH . 'includes/dossier-scientifique.php';
require_once LFI_NCT_PATH . 'includes/geo-routing.php';
require_once LFI_NCT_PATH . 'includes/enquete-validation.php';
require_once LFI_NCT_PATH . 'includes/rdv-points.php';
require_once LFI_NCT_PATH . 'includes/feedback.php';
require_once LFI_NCT_PATH . 'includes/enquete-completer.php';
require_once LFI_NCT_PATH . 'includes/nouveautes.php';
