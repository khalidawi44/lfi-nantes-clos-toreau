...
function lfi_nct_app_view_strategie() {
    ...
    echo '<li class="lfi-app-card" style="border-left:4px solid #c8102e"><div class="head"><div class="who">🛡️ Volet pénal — désamorcer les manœuvres</div></div>'
       . '<div class="com">Chaque courrier reçu est aussi lu sous l\'angle <strong>pénal</strong> : si l\'interlocuteur <strong>intimide</strong> un locataire ou tente un <strong>contournement illégal</strong> (dans la procédure ou dans les propos — report abusif sur le locataire, déni d\'un signalement, tentative de joindre la personne directement…), on l\'<strong>intègre dans la réponse pour couper court</strong>, par un rappel factuel du cadre légal. On <strong>rappelle</strong> le droit (y compris pénal) ; on n\'engage <strong>pas</strong> d\'acte judiciaire ici — ça, c\'est <strong>via l\'avocat</strong>.</div></li>';
    echo '</ul>';
    ...
    echo '<li class="lfi-app-card" style="border-left:4px solid #d39e00"><div class="head"><div class="who">📈 Christophe Jouin — escalade amiable (CA de NMH)</div></div>'
       . '<div class="com"><strong>christophe.jouin@mairie-nantes.fr</strong> — conseiller municipal ET membre du <strong>conseil d\'administration de NMH</strong> (supérieur de M. Morineau, agence Goudy). Il t\'a dit « fais-moi remonter les choses ». <em>Vous vous connaissez : fac de Nantes, UNEF ; il sait qui tu es, il sait que tu ne lâches pas l\'affaire.</em><br>'
       . '<strong>Quand :</strong> <strong>seulement</strong> quand le dialogue avec Morineau est <strong>rompu</strong> (pas de réponse / aucun mouvement après le délai — 8 j urgence, 2 mois sinon). On ne brûle pas ce levier trop tôt.<br>'
       . '<strong>Ce qu\'on lui donne :</strong> le <strong>nom du locataire concerné</strong> (indispensable : sans le nom, il ne peut pas décider une mutation/un relogement) + les demandes de CE dossier. Si la personne veut déménager, on donne son nom pour qu\'il puisse la muter.<br>'
       . '<strong>Garde-fous</strong> : on ne donne <strong>PAS l\'enquête entière</strong> (tous les locataires ne veulent pas être suivis) ni le chiffrage du préjudice ni la stratégie judiciaire. On montre l\'<strong>échelle</strong> comme pression : « ce dossier est l\'un des <strong>37 suivis</strong> parmi les <strong>67 recensés</strong> » → il voit le volume. Interlocuteur unique maintenu ; tout par écrit. Allié de circonstance : levier, pas arbitre.</div></li>';
    echo '</ul>';
